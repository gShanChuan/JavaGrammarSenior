...
public class StringCommonMethods {
    ...
    public void test4(){
        String s1 = "山东山东高山川";
        //替换 所有 oldChar
        System.out.println(s1.replace('东','山'));
        //替换 所有 target
        System.out.println(s1.replace("山山","上海"));
